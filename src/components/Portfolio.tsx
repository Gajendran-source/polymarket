const Portfolio = () => {
    return (
        <div className="max-w-[1400px] mx-auto px-4 py-8 text-white">

            {/* Top Cards */}
            <div className="grid md:grid-cols-2 gap-6 mb-8">

                {/* Portfolio Card */}
                <div className="bg-[#0f1720] border border-[#1f2a37] rounded-xl p-6">
                    <div className="flex justify-between items-start mb-6">
                        <div>
                            <p className="text-gray-400 text-sm">Portfolio</p>
                            <h2 className="text-3xl font-semibold">$0.00</h2>
                            <p className="text-gray-500 text-sm">$0.00 (0%) past day</p>
                        </div>
                    ...
                    <div className="flex gap-4">
                        ...
                        <button className="border border-gray-600 px-6 py-2 rounded-lg text-gray-300 hover:bg-gray-800">
                            Withdraw
                        </button>
                    </div>
                </div>
                ...
                <div className="bg-[#0f1720] border border-[#1f2a37] rounded-xl p-6">
                    <div className="flex justify-between mb-4">
                        <div>
                            ...
                            <p className="text-gray-500 text-sm">Past Month</p>
                        </div>
                    ...
                    {/* Chart Placeholder */}
                    <div className="h-16 bg-gradient-to-r from-blue-900/20 to-blue-500/20 rounded-md"></div>
                </div>
            ...
            <div className="flex gap-6 border-b border-gray-800 pb-3 mb-6">
                <button className="text-white font-medium">Positions</button>
            ...
            <div className="flex justify-between items-center mb-6">
                <input
                    type="text"
                    placeholder="Search"
                    className="bg-[#0f1720] border border-[#1f2a37] rounded-lg px-4 py-2 w-72 outline-none"
                />
            ...
            {/* Table */}
            <div className="bg-[#0f1720] border border-[#1f2a37] rounded-xl overflow-hidden">
